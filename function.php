...
$conn = mysqli_connect("localhost", "root", "", "dypa_ebudget");
...
$tanggal = $data["tanggal"];
$deskripsi = htmlspecialchars(mysqli_real_escape_string($conn, $data["deskripsi"]));
...
$deskripsi_laporan = htmlspecialchars(mysqli_real_escape_string($conn, $data["deskripsi_laporan"]));
...
$program = htmlspecialchars($data["program"]);
$tanggal = $data["tanggal_laporan"];
$deskripsi = htmlspecialchars(mysqli_real_escape_string($conn, $data["deskripsi_laporan"]));
$nom_acak = htmlspecialchars($data["dana_laporan"]);
$anggar = RemoveSpecialChar($nom_acak);
$anggaran = str_replace(' ', '', $anggar);
$ip = get_client_ip();
