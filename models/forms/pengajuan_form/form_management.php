...
<div id="form">
    <form action="" method="post" onsubmit="return validasi_input(this)" class="user">
        ...
        <div class="mb-3">
            ...
            <?php if ($id_management == "aset_yayasan") { ?>
            <input type="text" class="form-control" name="deskripsi" placeholder="pembelian Aset/bangungan"
                style="text-transform: capitalize;" autocomplete="off">

            <?php } elseif ($id_management == "gaji_karyawan") { ?>
            <input type="text" class="form-control" name="deskripsi" placeholder="Gaji Bulanan Karyawan"
                style="text-transform: capitalize;" autocomplete="off">

            <?php } elseif ($id_management == "uang_makan") { ?>
            <input type="text" class="form-control" name="deskripsi" placeholder="uang makan karyawan"
                style="text-transform: capitalize;" autocomplete="off">
            ...
            <?php } else { ?>
            <input type="text" class="form-control" name="deskripsi" placeholder="biaya lain lain"
                style="text-transform: capitalize;" autocomplete="off">
            <?php } ?>
        ...
        <div class="input-group mb-4">
            ...
            <input type="text" class="form-control admin_rp" name="anggaran" maxlength="11" placeholder="Nominal"
