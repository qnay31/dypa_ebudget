...
if ($_SESSION["id_pengurus"] == "manager_facebook") {
    if ($_SESSION["username"] == "leader_fb") {
        $where  = "id_pengurus LIKE 'facebook_depok%' AND team LIKE 'Facebook Tajur' GROUP BY nomor_id ORDER BY `team` DESC, pemegang ASC ";

    } else {
        $where  = "id_pengurus LIKE 'facebook_depok%' AND team LIKE 'Facebook Bogor' GROUP BY nomor_id ORDER BY `team` ASC, pemegang ASC ";
    }
