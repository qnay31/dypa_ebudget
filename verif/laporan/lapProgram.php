...
// kesehatan tajur
$q2  = mysqli_query($conn, "SELECT * FROM 2022_program WHERE MONTH(tgl_pemakaian) = '$periode' AND laporan = 'Terverifikasi' AND program = 'Program Kesehatan Yatim' AND cabang = 'Tajur' ");
...
// pendidikan tajur
$q3  = mysqli_query($conn, "SELECT * FROM 2022_program WHERE MONTH(tgl_pemakaian) = '$periode' AND laporan = 'Terverifikasi' AND program = 'Program Pendidikan Yatim' AND cabang = 'Tajur' ");
...
// program tajur
$q6  = mysqli_query($conn, "SELECT * FROM 2022_program WHERE MONTH(tgl_pemakaian) = '$periode' AND laporan = 'Terverifikasi' AND cabang = 'Tajur' ");
...
// sub cabang program
// pendidikan tajur
if ($program == 'Program Pendidikan Yatim' && $cabang == 'Tajur') {
    if (mysqli_fetch_assoc($c_query)) {
        $tes = mysqli_query($conn, "UPDATE `2022_data_program` SET 
            ...
            `anggaran_program_tajur`        ='$hasil_anggaran6',
            `terpakai_program_tajur`        ='$hasil_terpakai6',
        ...
        // kesehatan tajur
    } elseif ($program == 'Program Kesehatan Yatim' && $cabang == 'Tajur') {
        if (mysqli_fetch_assoc($c_query)) {
