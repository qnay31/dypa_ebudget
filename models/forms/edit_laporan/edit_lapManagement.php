    ...
    <form action="" method="post" onsubmit="return validasi_input2(this)">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="deskripsi_laporan" placeholder="Contoh: Pemakaian"
                value="<?= $data["pemakaian"] ?>" style="text-transform: capitalize;" autocomplete="off">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control admin_rp" name="qty" maxlength="11" placeholder="qty pembelian"
        ...
        <div class="input-group mb-4">
            ...
            <input type="text" class="form-control admin_rp" name="dana_laporan" maxlength="11" placeholder="Nominal"
