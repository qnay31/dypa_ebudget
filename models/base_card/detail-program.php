...
while($r = mysqli_fetch_array($sql))
{
    ...
    $d_anggaran3 = $r['anggaran_program_tajur'];
    $total_anggaran3[$i] = $d_anggaran3;

    $hasil_anggaran3 = array_sum($total_anggaran3);

    $d_terpakai3 = $r['terpakai_program_tajur'];
...
<div class="row">
    ...
    <div class="col-xxl-4 col-md-4">
        <div class="card info-card customers-card">
            <div class="card-body">
                <h5 class="card-title">Pendidikan Tajur</h5>
    ...
    <div class="col-xxl-4 col-md-4">
        <div class="card info-card customers-card">
            <div class="card-body">
                <h5 class="card-title">Kesehatan Tajur</h5>
    ...
    <div class="col-xxl-4 col-md-4">
        <div class="card info-card customers-card">
            <div class="card-body">
                <h5 class="card-title">Total Program Tajur</h5>
