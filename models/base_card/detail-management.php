...
if ($id_management == "aset_yayasan") {
    ...
    if ($_SESSION["id_pengurus"] == "ketua_yayasan" || $_SESSION["id_pengurus"] == "management_keuangan") {
        ...
        {
            $i++;   
            $d_anggaran = $r['anggaran_pembangunan_tajur'];
            $total_anggaran[$i] = $d_anggaran;

            $hasil_anggaran = array_sum($total_anggaran);

            $d_terpakai = $r['terpakai_pembangunan_tajur'];
            $total_terpakai[$i] = $d_terpakai;

            $hasil_terpakai = array_sum($total_terpakai);
            $cashback   = $hasil_anggaran - $hasil_terpakai;

            $d_anggaran2 = $r['anggaran_pembelian_tajur'];
            $total_anggaran2[$i] = $d_anggaran2;

            $hasil_anggaran2 = array_sum($total_anggaran2);

            $d_terpakai2 = $r['terpakai_pembelian_tajur'];
            $total_terpakai2[$i] = $d_terpakai2;

            $hasil_terpakai2 = array_sum($total_terpakai2);
            $cashback2   = $hasil_anggaran2 - $hasil_terpakai2;

            $hasil_anggaran3 = $hasil_anggaran+$hasil_anggaran2;

            $hasil_terpakai3 = $hasil_terpakai+ $hasil_terpakai2;
            $cashback3   = $hasil_anggaran3 - $hasil_terpakai3;
            $cashback3   = $hasil_anggaran3 - $hasil_terpakai3;
        }
    } else {
        {
            $i++;   
            $d_anggaran = $r['anggaran_pembangunan_bogor'];
            $total_anggaran[$i] = $d_anggaran;

            $hasil_anggaran = array_sum($total_anggaran);

            $d_terpakai = $r['terpakai_pembangunan_bogor'];
            $total_terpakai[$i] = $d_terpakai;

            $hasil_terpakai = array_sum($total_terpakai);
            $cashback   = $hasil_anggaran - $hasil_terpakai;

            $d_anggaran2 = $r['anggaran_pembelian_bogor'];
            $total_anggaran2[$i] = $d_anggaran2;

            $hasil_anggaran2 = array_sum($total_anggaran2);

            $d_terpakai2 = $r['terpakai_pembelian_bogor'];
            $total_terpakai2[$i] = $d_terpakai2;
    ...
    if ($_SESSION["id_pengurus"] == "ketua_yayasan" || $_SESSION["id_pengurus"] == "management_keuangan") {
        ...
        {
            $i++;   
            $d_anggaran = $r["anggaran_{$id_management}_aset_tajur"];
            $total_anggaran[$i] = $d_anggaran;
            // var_dump($d_anggaran);
            $hasil_anggaran = array_sum($total_anggaran);
    
            $d_terpakai = $r["terpakai_{$id_management}_aset_tajur"];
            $total_terpakai[$i] = $d_terpakai;
    
            $hasil_terpakai = array_sum($total_terpakai);
            $cashback   = $hasil_anggaran - $hasil_terpakai;
    
            $d_anggaran2 = $r["anggaran_{$id_management}_gedung_tajur"];
            $total_anggaran2[$i] = $d_anggaran2;
    
            $hasil_anggaran2 = array_sum($total_anggaran2);
    
            $d_terpakai2 = $r["terpakai_{$id_management}_gedung_tajur"];
            $total_terpakai2[$i] = $d_terpakai2;
        ...
        {
            $i++;   
            $d_anggaran = $r["anggaran_{$id_management}_aset_bogor"];
            $total_anggaran[$i] = $d_anggaran;
            // var_dump($d_anggaran);
            $hasil_anggaran = array_sum($total_anggaran);
    
            $d_terpakai = $r["terpakai_{$id_management}_aset_bogor"];
            $total_terpakai[$i] = $d_terpakai;
    
            $hasil_terpakai = array_sum($total_terpakai);
            $cashback   = $hasil_anggaran - $hasil_terpakai;
    
            $d_anggaran2 = $r["anggaran_{$id_management}_gedung_bogor"];
            $total_anggaran2[$i] = $d_anggaran2;
    
            $hasil_anggaran2 = array_sum($total_anggaran2);
    
            $d_terpakai2 = $r["terpakai_{$id_management}_gedung_bogor"];
            $total_terpakai2[$i] = $d_terpakai2;
    ...
    if ($_SESSION["id_pengurus"] == "ketua_yayasan" || $_SESSION["id_pengurus"] == "management_keuangan") {
        ...
        {
            $i++;   
            $d_anggaran = $r["anggaran_{$id_management}_tajur"];
            $total_anggaran[$i] = $d_anggaran;
            // var_dump($d_anggaran);
            $hasil_anggaran = array_sum($total_anggaran);

            $d_terpakai = $r["terpakai_{$id_management}_tajur"];
            $total_terpakai[$i] = $d_terpakai;
        ...
        {
            $i++;   
            $d_anggaran = $r["anggaran_{$id_management}_bogor"];
            $total_anggaran[$i] = $d_anggaran;
            // var_dump($d_anggaran);
            $hasil_anggaran = array_sum($total_anggaran);

            $d_terpakai = $r["terpakai_{$id_management}_bogor"];
            $total_terpakai[$i] = $d_terpakai;
...
<div class="row">
    ...
    <!-- Card -->
    <?php if ($id_management == "aset_yayasan" || $id_management == "maintenance" ) { ?>
        ...
        <div class="col-xxl-6 col-md-6">
            ...
            <div class="card info-card customers-card">
                <div class="card-body">
                    ...
                    <?php } else { ?>
                    <h5 class="card-title"><?= ucwords($judul) ?> Global</h5>
                    <?php } ?>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            ...
                            <h6 class="text-danger" data-bs-toggle="tooltip" data-bs-placement="right" title="Terpakai">
                                Rp.
