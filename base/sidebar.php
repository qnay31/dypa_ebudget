...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <!-- End Database Nav -->
        <?php if (
                    $_GET["id_forms"] == "daftar_pengajuan" || 
                    $_GET["id_forms"] == "forms_pengajuan" || 
                    $_GET["id_forms"] == "forms_verifikasi" || 
                    ...
                    $_GET["id_forms"] == "input_income" || 
                    $_GET["id_forms"] == "forms_verifIncome" || 
                    $_GET["id_forms"] == "edit_incomeMedia" || 
                    $_GET["id_forms"] == "forms_laporanIncome"|| 
                    $_GET["id_forms"] == "edit_laporanMedia"
                    ) { 
                ?>
        <li class="nav-item">
        ...
        <?php if (
            $_GET["id_grafik"] == "grafik_program" || 
            $_GET["id_grafik"] == "grafik_logistik" || 
            $_GET["id_grafik"] == "grafik_aset_yayasan" || 
            $_GET["id_grafik"] == "grafik_uang_makan" || 
            $_GET["id_grafik"] == "grafik_gaji_karyawan" || 
            $_GET["id_grafik"] == "grafik_anggaran_lain" || 
            $_GET["id_grafik"] == "grafik_maintenance" || 
            $_GET["id_grafik"] == "grafik_operasional_yayasan" || 
            $_GET["id_grafik"] == "grafik_pemasukanMedia") { 
        ?>
        <li class="nav-item">
