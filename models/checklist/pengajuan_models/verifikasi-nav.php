<nav class="stroke">
    <ul>
        ...
        <li>
            <a href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_pengajuanHumas">Pengajuan
                <?php if ($s > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s ?></span>
                <?php } ?>
            </a>
        ...
        <li>
            <a class="active" href="<?= $_SESSION["username"] ?>.php?id_checklist=checklist_verifikasiHumas">Verifikasi
                <?php if ($s2 > 0) { ?>
                <span class="badge badge-danger badge-counter"><?= $s2 ?></span>
                <?php } ?>
            </a>
