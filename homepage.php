...
if ($_SESSION["id_pengurus"] == "ketua_yayasan" || $_SESSION["id_pengurus"] == "management_keuangan" || $_SESSION["id_pengurus"] == "kepala_income" || $_SESSION["id_pengurus"] == "kepala_pengajuan") {
...
<body>
    ...
    <!-- checklist laporan -->
    <?php } elseif ($_GET["id_checklist"] == "checklist_laporan") { ?>
    <?php
